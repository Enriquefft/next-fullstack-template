        ...
        <div className="w-full">
          <div>
            ...
            <div className="relative">
              <input
                className="peer text-gray-500 block w-full rounded-md border border-gray-200 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500"
                id="email"
                type="email"
                name="email"
          ...
          <div className="mt-4">
            ...
            <div className="relative">
              <input
                className="peer block w-full text-gray-500 rounded-md border border-gray-200 py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500"
                id="password"
                type="password"
                name="password"
